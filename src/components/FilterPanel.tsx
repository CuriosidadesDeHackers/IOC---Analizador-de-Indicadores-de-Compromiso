...
const FilterPanel: React.FC<FilterPanelProps> = React.memo(({ onFilterChange, categories }) => {
                ...
                <div key={type} className="group/item">
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center space-x-2 truncate">
                      <IOCLogo type={type} className="w-3 h-3 sm:w-4 sm:h-4 text-blue-400 opacity-70 group-hover/item:opacity-100 transition-opacity" />
